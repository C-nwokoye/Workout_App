...
BARBELL_BENCH_PRESS = Exercise(
    ...
    strength_suitability=SuitabilityLevel.HIGH,
    hypertrophy_suitability=SuitabilityLevel.HIGH, 
...
DUMBBELL_BENCH_PRESS = Exercise(
    ...
    strength_suitability=SuitabilityLevel.MEDIUM,
    hypertrophy_suitability=SuitabilityLevel.HIGH,  
    primary_muscle=MuscleGroup.CHEST, 
    exercise_type=ExerciseType.COMPOUND, 
    movement_pattern=MovementPattern.HORIZONTAL_PUSH,
...
CABLE_FLY = Exercise(
    id="cable_fly", 
    name="Cable Fly",
    strength_suitability=SuitabilityLevel.LOW,
    hypertrophy_suitability=SuitabilityLevel.HIGH,  
    primary_muscle=MuscleGroup.CHEST, 
    exercise_type=ExerciseType.COMPOUND, 
    movement_pattern=MovementPattern.HORIZONTAL_PUSH,
